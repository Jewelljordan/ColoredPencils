...
//History
void displayHistory(vector<History>& history,vector<Product> inventory, string HistoryID);
...
int main()
{
    ...
    cout << "Welcome to Hues and Doodles!" << endl << "Choose your next step." << endl;
	while (true) {
		cout << "1. Exit" << endl;
		cout << "2. Login" << endl;
		...
		if (num == 1) { //Exit
			...
			while (true) {
				...
				cout << endl;
				while(num2 != 1 && num2 != 2 && num2 != 3 && num2 != 4 && num2 != 5)
					{
						cout << "This is not one of the options try again." << endl;
						cin >> num2;
					}
				...
				if (num2 == 1) { //view inventory
					while (true) {
						...
						cout << endl;
						while(num3 != 1 && num3 != 2 && num3 != 3 && num3 != 4)
							{
								cout << "This is not one of the options try again." << endl;
								cin >> num3;
							}
					...
					displayHistory(history, inventory, current.getHistoryID());
					while (true) {
						cout << "1. Add item to cart" << endl;
						cout << "2. Go Back" << endl;
...
void addToInventory(vector<Product>& inventory, string productID, string name, string price, string amount) {
	...
	outfile << name << ";" << amount << ";" << productID << ";" << price << endl;
